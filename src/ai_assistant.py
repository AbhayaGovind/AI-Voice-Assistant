...
class AIAssistant(ConversationalAssistant):
    def __init__(
        self, ai_provider: AIProvider = ai.Ollama(), name: str = "AI Assistant"
    ):
        super().__init__(ai_provider=ai_provider, name=name)
...
class AISingleton:
    ...
    def initialize_assistant(
        cls, ai_provider: AIProvider = None, name: str = "AI Assistant"
    ) -> AIAssistant:
...
def get_ai_assistant() -> AIAssistant:
    ...
    print(
        f"Using AI Assistant: {assistant.name} , AI Provider: {assistant.ai_provider.name} ID {id(assistant)}"
    )
    return assistant


def initialize_ai_assistant(
    ai_provider: AIProvider = None, name: str = "AI Assistant"
) -> AIAssistant:
